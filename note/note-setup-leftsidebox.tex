...
% huanengchen@foxmail.com 2025-11-27
%===================================
...
\renewcommand{\maketitle}{
    ...
    \begin{center} % 标题居中对齐
        ...
        {\huge \@title \par} % 标题
    \end{center}
    % 可以注释下面的 \@author 和 \@date 隐藏不必要的信息
    \begin{center} % 居中对齐
        {% 添加期刊名称和论文作者
            \ifx\paperauthor\empty
                \ifx\journalname\empty
                    % 两者都为空，不添加额外垂直间距
                \else
                    \hfill \textbf{Journal:} \journalname \par
                \fi
            \else
                \ifx\journalname\empty
                    \textbf{Paper Author:} \paperauthor \hfill \mbox{} \par
                \else
                    \textbf{Paper Author:} \paperauthor \hspace{\fill} \textbf{Journal:} \journalname \par
                \fi
            \fi
            \vspace{-0.2cm}
        }
